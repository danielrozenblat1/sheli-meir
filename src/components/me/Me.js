            ...
            <div className={styles.story}>
              <div className={styles.storySection}>
                <p className={styles.storyText}>
                  הייתי שוטרת תנועה, על הנייר הייתה לי עבודה בטוחה אבל משהו הרגיש לי חסר. קמתי כל בוקר עם תחושה שאני לא ממצה את עצמי וידעתי שאני לא במקום הנכון. תמיד אהבתי את עולם היופי, אבל כל מי שסביבי הזהיר אותי: "אין בזה כסף", "יש יותר מדי תחרות", "זה לא מקצוע אמיתי". הקשבתי להם יותר מדי זמן - עד שהחלטתי להפסיק.
                </p>
              </div>
